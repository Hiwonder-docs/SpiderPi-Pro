...
VNC is a graphics remote control software. With VNC, we can control the
Raspberry Pi directly from your computer by connecting the hotspot created by Raspberry Pi. Next, you will learn how to use VNC.
...
(3) Then click  **"I accept the terms in the License Agreement"**  in the prompt box, and click  **"Next"** to enter the next step.
