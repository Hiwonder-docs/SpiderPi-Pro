...
(1) Start robot. (The switch is on Raspberry Pi expansion board). For detailed instruction, please refer to the file in "**[Getting Ready\1.4 Charging and Power-On Status Explanation]()**".
...
Follow the tutorial in [2.1 APP Installation and Connection]()  to install the app and connect to the SpiderPi Pro.
...
* If the recognition effect is not good enough, please refer to  “[2.3. Color Threshold Adjustment]()”.
  :::
