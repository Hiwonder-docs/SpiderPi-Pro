...
`current_pos[5] = [-300, 100, -50]" and "current_pos[0] = [-300, -100, -50]` are used to control the movement of the leg. Take `current_pos[5] = [-300, 100, -50]` for example.
...
(12) Enter command in turn to run the calibration program.
...
(1) Import the libraries related to OpenCV, time, math, and threads. If want to call a function in library, you can use "library name+function name (parameter, parameter)". For example:</span>
...
## 7. Line Following and Transferring
...
**7.4.2 Parameter of red line detection**
...
**7.4.3 Parameters of line following**
...
**7.4.4 Parameters of colored block detection**
...
**7.4.5 Parameters of intelligent transferring**
...
**7.4.6 Parameters of block placing**

After picking the block, the robot will transfer it to the designated position. The specific the operation is as follow.

(1) The robot starts crawling along the red line. The parameters of this part are illustrated in "4.2 Parameters of red line detection" and "4.3 Parameters of line following"
